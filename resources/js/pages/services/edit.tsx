...
export default function ServicesEdit({ service, participants, agencies }: ServicesEditProps) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        participant_id: service.participant_id || '',
        agency_id: service.agency_id || '',
        type: service.type || '',
        weekly_hours: service.weekly_hours?.toString() || '',
        weekly_units: service.weekly_units?.toString() || '',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Service: ${service.type}`} />
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
                <div className="flex items-center justify-between">
                    <Heading title={`Edit ${service.type} Service`} />
